...
function update_particles!( particles :: Particles, 
    ...
    for m = 1:nbpart
        ...
        for n = 1:nτ
            tmp[n] = tmp[n]*exp(1im*ua.lτ[n]*t/ua.ε)/ua.nτ
        end 
    ...
    for istep = 1:2
        ...
        for m=1:nbpart
            ...
            for n=1:nτ
                ...
                fx1[n,m] = ( cos(τ[n]) * yt1[n,m] + sin(τ[n]) * yt2[n,m])/b
                fx2[n,m] = (-sin(τ[n]) * yt1[n,m] + cos(τ[n]) * yt2[n,m])/b
                ...
                fy1[n,m] = (cos(τ[n])*tmp1-sin(τ[n])*tmp2)/b
                fy2[n,m] = (sin(τ[n])*tmp1+cos(τ[n])*tmp2)/b
        ...
        for m=1:nbpart
            ...
            for n = 1:nτ
                ...
                gx1[n,m]=( cos(τ[n])*yt1[n,m]+sin(τ[n])*yt2[n,m])/b
                gx2[n,m]=(-sin(τ[n])*yt1[n,m]+cos(τ[n])*yt2[n,m])/b
                ...
                gy1[n,m] = (cos(τ[n])*temp1-sin(τ[n])*temp2)/b
                gy2[n,m] = (sin(τ[n])*temp1+cos(τ[n])*temp2)/b
